...
-- These fields store refund method, reason, and bank details for credit/bank refunds
...
DO $$
BEGIN
  RAISE NOTICE 'Refund fields (refund_method, refund_reason, refund_bank_details) added to orders table successfully!';
END $$;
