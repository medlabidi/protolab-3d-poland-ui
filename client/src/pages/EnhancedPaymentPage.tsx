...
export function EnhancedPaymentPage() {
  ...
  const [selectedMethod, setSelectedMethod] = useState<'card' | 'pbl' | 'blik' | 'installment'>('card');
  ...
  const handlePayment = async () => {
    ...
    try {
      ...
      switch (selectedMethod) {
        ...
        case 'installment':
          throw new Error('Installments not yet implemented');
      }
      ...
      } else if (data.status === 'SUCCESS' || data.statusCode === 'SUCCESS') {
            ...
            <CardContent>
              <Tabs value={selectedMethod} onValueChange={(v) => setSelectedMethod(v as any)}>
                <TabsList className="grid w-full grid-cols-4">
                  ...
                  <TabsTrigger value="installment" disabled>
                    Installments
                  </TabsTrigger>
                </TabsList>
                ...
                <TabsContent value="installment" className="space-y-4 mt-4">
                  <Alert>
                    <AlertDescription>Installment payments coming soon</AlertDescription>
                  </Alert>
                </TabsContent>
              </Tabs>
              ...
              <div className="mt-6 space-y-4">
                <Button
                  ...
                  disabled={processing || (selectedMethod === 'card' && !cardToken)}
                  className="w-full"
                  size="lg"
                >
                  {processing ? (
