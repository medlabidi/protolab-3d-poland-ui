...
const DesignAssistance = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Basic validation - only check for idea description
    if (!formData.ideaDescription) {
      toast({
        title: "Missing Information",
        description: "Please provide a description of your design idea",
        variant: "destructive",
      });
      return;
    }
                ...
                <div className="space-y-3">
                  ...
                  >
                    ...
                    <label htmlFor="attached-files" className="cursor-pointer block">
                      ...
                      <p className="text-muted-foreground text-sm">Any reference files: photos, sketches, PDFs, CAD files, etc. (up to 50MB)</p>
                    </label>
                  </div>
